  ...
  await prisma.exercise.createMany({
    data: [
      ...
      },
      {
        ...
        category: 'Груди',
        calories: 120,
        muscleGroup: 'Груди, Трицепс, Дельти',
        level: 'Середній',
        equipment: 'Штанга',
      ...
      },
      {
        ...
        title: 'Розведення гантелей через сторони',
        category: 'Плечі',
        calories: 55,
        muscleGroup: 'Дельти',
        level: 'Початковий',
        ...
        description:
          "Ізольована вправа для середнього пучка дельтоподібного м'яза. Формує ширину плечей і V-подібний силует.",
        steps: [
      ...
      },
      {
        ...
        category: 'Ноги',
        calories: 150,
        muscleGroup: 'Квадрицепс, Сідниці, Кор',
        level: 'Середній',
        equipment: 'Штанга',
      ...
      },
      {
        ...
        category: 'Ноги',
        calories: 95,
        muscleGroup: 'Задня поверхня стегна, Сідниці',
        level: 'Початковий',
        equipment: 'Гантелі',
        videoUrl: 'https://www.youtube.com/watch?v=7j-2w4-P14I',
        description:
          'Вправа для задньої поверхні стегна та сідниць. Відмінно підходить для зміцнення задньої кінетичної ланки.',
        steps: [
        ...
        alternatives: {
          home: ['Ягідковий місток на одній нозі', 'Нахили корпусу з рюкзаком'],
          outdoor: ['Тяга на одній нозі з опорою на лавку', 'Ягідковий місток на лавці'],
          band: ['Румунська тяга з гумовою стрічкою', 'Good morning з гумою'],
        },
      },
      {
        slug: 'dumbbell-bicep-curl',
        title: 'Згинання рук з гантелями на біцепс',
        category: 'Руки',
        calories: 50,
        muscleGroup: 'Біцепс',
        level: 'Початковий',
      ...
      },
      {
        ...
        description:
          "Тягова вправа в тренажері для розвитку широчайших м'язів спини. Імітує підтягування і підходить для тих, хто ще не може підтягуватись.",
        steps: [
      ...
      {
        slug: 'hip-thrust',
        title: 'Ягідковий місток зі штангою',
        category: 'Сідниці',
        calories: 105,
        muscleGroup: 'Сідниці, Задня поверхня стегна',
        level: 'Середній',
        equipment: 'Штанга',
        ...
        mistakes: [
          'Переrozгинання в попереку у верхній точці.',
          "Відштовхування носками замість п'ятами.",
          'Занадто далеке або близьке розташування стоп.',
        ],
        alternatives: {
          home: ['Ягідковий місток на одній нозі без ваги', 'Ягідковий місток з паузою'],
          outdoor: ['Ягідковий місток на лавці в парку', 'Зашагування з акцентом на сідниці'],
          band: ['Ягідковий місток з гумовою стрічкою на стегнах', 'Відведення ноги з гумою'],
        },
      },
    ],
  });
